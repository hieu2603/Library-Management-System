...
INSERT INTO `book` (`book_id`, `title`, `author`, `publisher_id`, `year_publish`, `category_id`, `quantity`, `book_image`, `bookshelf_id`) VALUES
	(1, 'The Great Gatsby', 'F. Scott Fitzgerald', 1, 1925, 1, 0, 'gatsby.jpg', 1),
	(2, '1984', 'George Orwell', 1, 1949, 2, 0, '1984.jpg', 2),
	(3, 'To Kill a Mockingbird', 'Harper Lee', 3, 1960, 1, 0, 'mockingbird.jpg', 3);
...
INSERT INTO `member` (`member_id`, `full_name`, `phone`, `email`, `address`, `membership_date`, `status`, `violationCount`) VALUES
	...
	(3, 'Đỗ Lê Anh Khoa', '0222333444', 'lvanc@gmail.com', '789 West St', '2022-03-01', 'Đang hoạt động', 0);
...
-- Dumping data for table library_management.penaltyticket_detail: ~0 rows (approximately)
...
-- Dumping data for table library_management.supplier: ~4 rows (approximately)
