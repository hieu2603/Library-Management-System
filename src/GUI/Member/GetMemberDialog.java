 ...
 * @author Duc3m
 */
public class GetMemberDialog extends javax.swing.JDialog {

    MemberBUS memberBUS = new MemberBUS();
    ArrayList<MemberDTO> memberList;
    public boolean choosen = false;
    
    public GetMemberDialog(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
        customInit();
    }
        ...
        btn_choose.addMouseListener(new MouseAdapter() {
            ...
            public void mousePressed(MouseEvent e) {
                try {
                    ...
                    JOptionPane.showMessageDialog(null, "Chưa chọn thành viên");
                }
            }
        });
    ...
    public void loadDataToTable(ArrayList<MemberDTO> staffList) {
